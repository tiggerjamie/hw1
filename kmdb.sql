...
INSERT INTO performers (movie_id, actor_id, role)
...
-- TODO!
SELECT title, release_year, mpaa_rating, studio_name
...
FROM movies INNER JOIN performers ON movies.id = performers.movie_id
